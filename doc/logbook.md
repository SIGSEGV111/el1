...
`stderr` immediately and includes the monotonic time since process start, log
verbosity, category, thread name and formatted message. The default console
filter is `OPERATIONAL` and above.
...
```text
[+0.012345] OPERATIONAL/STATE_CHANGE [main] server started on port 8080
```
