...
console.log('static const char_map_t CHAR_MAP[] = {');
for([unicode, dram] of Object.entries(_jp.cmap))
{
	if(Array.isArray(dram))
	{
		console.log('\t{ ' + unicode + ', ' + dram[0] + '},');
	}
	else
	{
		console.log('\t{ ' + unicode + ', ' + dram + '},');
	}
}
console.log('};');
