gen/std/io_stream.o: src/el1/io_stream.cpp src/el1/io_stream.hpp src/el1/def.hpp \
 ...
 src/el1/io_text.hpp src/el1/io_collection_map.hpp
	mkdir -p gen/std
	'/bin/g++' src/el1/io_stream.cpp -o gen/std/io_stream.o -c '-DEL1_WITH_POSTGRES' '-DEL1_WITH_VALGRIND' '-ftemplate-depth=50' '-fPIC' '-fdiagnostics-color=always' '-Wall' '-Wextra' '-Werror' '-Wno-unused-parameter' '-Wno-error=unused-function' '-I' 'submodules/googletest/googletest/include' '-std=gnu++20' '-Wno-unused-const-variable' '-I/usr/include/pgsql' '-DOPENSSL_LOAD_CONF' -I src
