gen/std/dev_i2c_opt3001.o: src/el1/dev_i2c_opt3001.cpp \
 ...
 src/el1/util_function.hpp
	mkdir -p gen/std
	'/bin/g++' src/el1/dev_i2c_opt3001.cpp -o gen/std/dev_i2c_opt3001.o -c '-DEL1_WITH_POSTGRES' '-DEL1_WITH_VALGRIND' '-ftemplate-depth=50' '-fPIC' '-fdiagnostics-color=always' '-Wall' '-Wextra' '-Werror' '-Wno-unused-parameter' '-Wno-error=unused-function' '-I' 'submodules/googletest/googletest/include' '-std=gnu++20' '-Wno-unused-const-variable' '-I/usr/include/pgsql' '-DOPENSSL_LOAD_CONF' -I src
