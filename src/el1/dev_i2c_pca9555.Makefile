gen/std/dev_i2c_pca9555.o: src/el1/dev_i2c_pca9555.cpp \
 src/el1/dev_i2c_pca9555.hpp src/el1/def.hpp src/el1/dev_i2c.hpp \
 ...
 src/el1/util_function.hpp
	mkdir -p gen/std
	'/bin/clang++' src/el1/dev_i2c_pca9555.cpp -o gen/std/dev_i2c_pca9555.o -c '-O0' '-g' '-flto' '-DEL1_WITH_POSTGRES' '-DEL1_WITH_VALGRIND' '-ftemplate-depth=50' '-fPIC' '-fdiagnostics-color=always' '-Wall' '-Wextra' '-Werror' '-Wno-unused-parameter' '-Wno-error=unused-function' '-I' 'submodules/googletest/googletest/include' '-std=gnu++20' '-Wno-unused-const-variable' '-I/usr/include/pgsql' '-DOPENSSL_LOAD_CONF' -I src
	./support/generate-cpp-makefile.sh src/el1/dev_i2c_pca9555.cpp
